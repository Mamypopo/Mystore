<template>
  <section>
    ...
    <div class="container">
      <h1 class="section-title">รายการสินค้า</h1>
...
export default {
  data() {
    return {
      slides: [
        { image: 'https://via.placeholder.com/1920x1080', title: 'Slide 1' },
        { image: 'https://via.placeholder.com/1920x1080', title: 'Slide 2' },
        { image: 'https://via.placeholder.com/1920x1080', title: 'Slide 3' },
      ],
      currentSlide: 0,
      categories: [],
      products: [],
  ...
  async created() {
    try {
      ...
      this.products = productResponse.data.map(product => ({ ...product, quantity: 1 }));
    } catch (error) {
